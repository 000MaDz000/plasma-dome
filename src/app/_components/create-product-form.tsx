...
export default function CreateProductForm() {
    ...
    return (
        <form method="post" encType="multipart/form-data" action="/api/products" className="grid md:grid-cols-2 gap-3">
            ...
            <Input name="categories" placeholder={t("categories")} className="border p-3 col-span-2" />
            ...
            <TextareaAutosize name="description" placeholder={t("description")} className="border p-3 col-span-2 row-span3 min-h-60" />
